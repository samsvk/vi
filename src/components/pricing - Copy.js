...
export default function Pricing() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen font-inter min-w-screen bg-main-default text-[#aaa] tracking-tight font-normal text-sm relative">
      <div className="min-h-[400px] flex items-start justify-center w-full max-w-max ">
        <div className="relative z-10 flex flex-col justify-center w-full px-6 py-4 border rounded-lg border-white/5 h-max bg-black/10">
            ...
            <ul className="flex items-center gap-4">
              ...
              {CHARACTER_OPTIONS.map((option, index) => {
                ...
                return (
                  <li
                    key={index}
                    className={`py-1 px-2.5 bg-white/5 rounded-md border border-white/5 hover:cursor-pointer ${
                      isSelected === option
          ...
          <div className="py-3 border-b border-white/5">
            <ul className="flex items-center gap-4">
              <label className="text-xs opacity-50 ">Style:</label>
